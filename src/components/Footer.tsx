  ...
  return (
    <footer className="bg-gray-900 text-white">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 xl:px-12 py-12">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 sm:gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="text-xl font-bold">brixem</span>
            </div>
            <p className="text-gray-300 mb-6 max-w-md">
              Transforming construction projects with intelligent tools, real industry expertise, 
              and AI-driven insights for homeowners, contractors, and consultants.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link href="/platform" className="text-gray-300 hover:text-white transition">Platform</Link></li>
              <li><Link href="/solutions" className="text-gray-300 hover:text-white transition">Solutions</Link></li>
              <li><Link href="/pricing" className="text-gray-300 hover:text-white transition">Pricing</Link></li>
              <li><Link href="/" className="text-gray-300 hover:text-white transition">Brixem AI</Link></li>
            </ul>
          </div>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 flex flex-col sm:flex-row justify-between items-center gap-4 sm:gap-0">
          <p className="text-gray-400 text-sm">
            © 2024 Brixem. All rights reserved.
          </p>
