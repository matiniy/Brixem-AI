...
const LinearTaskFlow: React.FC<LinearTaskFlowProps> = ({ 
  ...
  const getStepIcon = (step: TaskStep, stepIndex: number) => {
    ...
    const isPreviousStep = stepIndex < steps.findIndex(s => s.status !== 'completed');
                        ...
                        <div className="p-4 bg-white">
                          ...
                          {step.details && (
                            <div className="mt-4 space-y-4">
                              {/* Materials, Requirements, Deliverables Cards */}
                              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                {step.details.materials && step.details.materials.length > 0 && (
                                  <div className="bg-gray-50 rounded-lg p-4 border border-gray-200">
                                    <div className="flex items-center justify-between mb-3">
                                      <h6 className="text-sm font-semibold text-gray-900">Materials Required</h6>
                                      <div className="flex items-center space-x-1">
                                        <button className="p-1 text-gray-400 hover:text-gray-600" title="Add attachment">
                                ...
                                {step.details.requirements && step.details.requirements.length > 0 && (
                                  <div className="bg-gray-50 rounded-lg p-4 border border-gray-200">
                                    <div className="flex items-center justify-between mb-3">
                                      <h6 className="text-sm font-semibold text-gray-900">Requirements</h6>
                                      <div className="flex items-center space-x-1">
                                        <button className="p-1 text-gray-400 hover:text-gray-600" title="Add attachment">
                                          <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15.172 7l-6.586 6.586a2 2 0 102.828 2.828l6.414-6.586a4 4 0 00-5.656-5.656l-6.415 6.585a6 6 0 108.486 8.486L20.5 13" />
                                ...
                                {step.details.deliverables && step.details.deliverables.length > 0 && (
                                  <div className="bg-gray-50 rounded-lg p-4 border border-gray-200">
                                    <div className="flex items-center justify-between mb-3">
                                      <h6 className="text-sm font-semibold text-gray-900">Deliverables</h6>
                                      <div className="flex items-center space-x-1">
                                        <button className="p-1 text-gray-400 hover:text-gray-600" title="Add attachment">
                                          <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15.172 7l-6.586 6.586a2 2 0 102.828 2.828l6.414-6.586a4 4 0 00-5.656-5.656l-6.415 6.585a6 6 0 108.486 8.486L20.5 13" />
