    ...
    <>
      ...
      <section className={`relative bg-white overflow-hidden transition-all duration-500 ease-in-out min-h-screen flex items-center ${isChatActive ? 'py-8 sm:py-12 md:py-16 lg:py-20' : 'py-12 sm:py-16 md:py-20 lg:py-24'}`}>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 md:px-8 lg:px-12 text-center relative z-10 w-full">
          ...
          {/* Smaller Subheadline */}
          <p className={`font-normal text-gray-600 transition-all duration-500 mb-1 sm:mb-1 ${isChatActive ? 'text-xs sm:text-sm mb-0 sm:mb-1' : 'text-sm sm:text-base md:text-lg mb-1 sm:mb-1'}`} style={{fontWeight: '400'}}>
          ...
          <div className={`flex flex-col justify-center items-center transition-all duration-500 w-full max-w-2xl mx-auto ${isChatActive ? 'mt-1 sm:mt-1' : 'mt-1 sm:mt-1'}`}>
